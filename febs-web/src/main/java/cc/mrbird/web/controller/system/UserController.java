...
public class UserController extends BaseController {
    ...
    @RequestMapping("user/Clazzlist")
    @ResponseBody
    public Map<String, Object> userListWithClazz(QueryRequest request, MyUser user) {
        return super.selectByPageNumSize(request, () -> this.userMapper.findUserWithDeptWithClazz(user));
    }
