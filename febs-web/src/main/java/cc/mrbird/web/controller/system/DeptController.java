...
public class DeptController {
    ...
    public ResponseBo getDeptTree() {
        try {
            ...
            log.error("获取学院树失败", e);
            return ResponseBo.error("获取学院树失败！");
        }
    }
    ...
    public ResponseBo getDept(Long deptId) {
        try {
            ...
            return ResponseBo.error("获取学院信息失败，请联系网站管理员！");
        }
    }
    ...
    public ResponseBo addRole(Dept dept) {
        try {
            ...
            return ResponseBo.ok("新增学院成功！");
        } catch (Exception e) {
            log.error("新增学院失败", e);
            return ResponseBo.error("新增学院失败，请联系网站管理员！");
        }
    }
    ...
    public ResponseBo deleteDepts(String ids) {
        try {
            ...
            return ResponseBo.ok("删除学院成功！");
        } catch (Exception e) {
            log.error("删除学院失败", e);
            return ResponseBo.error("删除学院失败，请联系网站管理员！");
        }
    }
    ...
    public ResponseBo updateRole(Dept dept) {
        try {
            ...
            return ResponseBo.ok("修改学院成功！");
        } catch (Exception e) {
            log.error("修改学院失败", e);
            return ResponseBo.error("修改学院失败，请联系网站管理员！");
        }
    }
    ...
    public ResponseBo deptExcel(Dept dept) {
        try {
            ...
            return FileUtils.createExcelByPOIKit("学院表", list, Dept.class);
        } catch (Exception e) {
            log.error("导出学院信息Excel失败", e);
    ...
    public ResponseBo deptCsv(Dept dept) {
        try {
            List<Dept> list = this.deptService.findAllDepts(dept);
            return FileUtils.createCsv("学院表", list, Dept.class);
        } catch (Exception e) {
            log.error("获取学院信息Csv失败", e);
